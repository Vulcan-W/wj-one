  ...
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="customerList" @selection-change="handleSelectionChange">
      ...
      <el-table-column fixed="right" label="操作" align="left" class="small-padding" width="250px">
        <template slot-scope="scope">
          <el-button size="mini" type="text" icon="el-icon-edit-outline" @click="handleComment(scope.row)" v-hasPermi="['mapper:customer:followup']">写跟进</el-button>
