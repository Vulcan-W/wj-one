<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button type="danger" plain icon="el-icon-delete" size="mini" @click="handleDelete" v-hasPermi="['crm:order:remove']">删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button type="info" plain icon="el-icon-download" size="mini" @click="handleExport" v-hasPermi="['crm:order:export']">导出</el-button>
      </el-col>
...
export default {
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport () {
      this.download('mapper/order/export', {
        ...this.queryParams
